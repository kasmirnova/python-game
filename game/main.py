# Над данной программой работала команда: Мамедов Артем и Смирнова Катерина
# ЗАДАНИЯ
# Артем: рисовал изображения для игры, а также подбирал фоновую музыку
# Катя: написание кода
# Артем и Катя: архитектура кода
# РОЛИ
# Артем: дизайнер + тестеровщик
# Катя: проджект менеджер + разработчик
# Данная игра не является легкой, особенно для ПК. Поэтому счетчик не сломан :)
import pygame
import sys
import random
